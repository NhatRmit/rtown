...
const DisclaimerPage = () => {
  return (
    <Layout className='disclaimer-container' header footer>
      <h1 className="title">Disclaimer for RTown</h1>

      <p>
        If you require any more information or have any questions about our
        site's disclaimer, please feel free to contact us by email at
        rtown.support@rmit.edu.vn. Our Disclaimer was generated with the help of
        the{" "}
      ...
      <h2>Disclaimers for RTown</h2>

      <p>
        All the information on this website - https://github.com/NhatRmit/rtown
        - is published in good faith and for general information purpose only.
        RTown does not make any warranties about the completeness, reliability
        and accuracy of this information. Any action you take upon the
        information you find on this website (RTown), is strictly at your own
        risk. RTown will not be liable for any losses and/or damages in
